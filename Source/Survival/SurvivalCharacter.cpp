...
void ASurvivalCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(ia_Dash, ETriggerEvent::Started, this, &ASurvivalCharacter::Dash);
		EnhancedInputComponent->BindAction(ia_Fire, ETriggerEvent::Triggered, this, &ASurvivalCharacter::Fire);
	}
	else
	{
...
void ASurvivalCharacter::Dash()
{
	...
	GetWorld()->GetTimerManager().SetTimer(
		InvincibleTimer,
		this,
		&ASurvivalCharacter::EndInvincible,
		InvincibleTime,
		false
	);
	...
	GetWorld()->GetTimerManager().SetTimer(
		DodgeTimer,
		this,
		&ASurvivalCharacter::EndDodge,
		DodgeDuration,
		false
	);
}
void ASurvivalCharacter::EndDodge()
{
	bIsDodging = false;
}
void ASurvivalCharacter::EndInvincible()
{
	bInvincible = false;
}
...
void ASurvivalCharacter::TakeEnemyDamage(int32 Damage)
{
	HP -= Damage;
	OnHPChanged();
	if (HP <= 0)
...
void ASurvivalCharacter::OnHPChanged()
{
	if (HPUI)
	{
